...
export const updateOrderStatusValidation: RequestHandler = (req, res, next) => validator(orderSchema.updateOrderStatus, { ...req.body }, next);

export const createStripeCheckoutSessionValidation: RequestHandler = (req, res, next) => validator(orderSchema.createStripeCheckoutSession, { ...req.body }, next);
