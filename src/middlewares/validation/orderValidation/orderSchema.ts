...
export const orderSchema = {
  ...
  updateOrderStatus: Joi.object({
    orderStatus: Joi.string()
      .required()
      .valid(orderStatus.cancelled, orderStatus.completed, orderStatus.delivered, orderStatus.pending, orderStatus.shipped, orderStatus.waitingPayment, orderStatus.waitingPickup),
  }),
