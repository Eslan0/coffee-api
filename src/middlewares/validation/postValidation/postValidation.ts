...
export const updatePostValidation: RequestHandler = (req, res, next) => validator(postSchema.updatePost, { ...req.file, ...req.body, ...req.params }, next);
...
export const addCommentValidation: RequestHandler = (req, res, next) => validator(postSchema.addComment, { ...req.file, ...req.body, ...req.params }, next);
