...
export const orderSchema: Schema<OrderT> = new Schema(
  {
    ...
    orderStatus: {
      type: String,
      required: true,
      enum: [orderStatus.cancelled, orderStatus.completed, orderStatus.delivered, orderStatus.pending, orderStatus.shipped, orderStatus.waitingPayment, orderStatus.waitingPickup],
