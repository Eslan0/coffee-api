...
import { AuthenticatedRequestBody, IUser, ProcessingStripeCheckoutT } from "../interfaces";
...
export const createStripeCheckoutSessionService = async (req: AuthenticatedRequestBody<ProcessingStripeCheckoutT>, res: Response, next: NextFunction) => {
